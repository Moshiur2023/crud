                        ...
                        <form class="needs-validation" action="{{ route('products.update',$products->id) }}" method="post" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" value="{{$products->product_name}}" name="product_name" id="productName" placeholder=""  required="">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" value="{{$products->price}}" name="price" id="phone" >
